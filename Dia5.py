...
# 8. "con_caracter.py" Pide un caracter al usuario. Indicará si es o no vocal. Finaliza con la introducción de un "*".
# 9. "pares.py" Imprime todos los números pares entre dos números que se le pidan al usuario.
# 10. "intervalo.py" Se le pide al usuario que introduzca el limite inferior y superior de un intervalo.  Si el límite inferior es mayor que el superior lo tiene que volver a pedir.  A continuación se van introduciendo números hasta que introduzcamos el 0. Entonces el programa dará las siguientes informaciones:
#     - La suma de los números que están dentro del intervalo (intervalo abierto).
#     - Cuántos números están fuera del intervalo.
#     - Informa si hemos introducido algún número igual a los límites del intervalo.
# 11. "potencia_sin.py" Pide  dos números, uno real (base) y un entero positivo (exponente). Sacará  por pantalla el resultado de la potencia sin utilizar el operador de potencia.
